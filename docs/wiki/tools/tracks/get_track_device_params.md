---
name: "get_track_device_params"
summary: ""
Live mapping: "- Iterates `device.parameters` and returns `index`, `name`, `raw_value`, `display_value`, `min`, `max`, `is_quantized`, and `value_items` for each parameter."
---

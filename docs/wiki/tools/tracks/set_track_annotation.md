---
name: "set_track_annotation"
summary: ""
Live mapping: "- If `track.annotation` exists, sets `track.annotation = str(annotation_text)` and returns the updated annotation."
---
...
```json
{
  "action": "set_track_annotation",
  "track_index": 1,
  "annotation_text": "New notes"
}
```

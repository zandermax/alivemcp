---
name: "get_track_available_output_routing_types"
summary: ""
Live mapping: "- If `track.available_output_routing_types` is present, collects `routing.display_name` for each available routing."
---

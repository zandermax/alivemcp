---
name: "set_track_input_sub_routing"
summary: ""
Live mapping: "- If `track.input_sub_routing` is present, attempts to set it or returns a message describing limitations."
---
...
```json
{
  "action": "set_track_input_sub_routing",
  "track_index": 1,
  "sub_routing": "L/R"
}
```

---
name: "get_rack_contents"
summary: ""
Live mapping: "- Uses `device.chains` and `chain.devices` to build a nested representation of rack contents."
---
    ...
    "chains": [
      {
        "index": 0,
        "name": "Chain 1",
        "devices": [{ "name": "Synth", "class_name": "Operator" }]
      }
    ]
  }
}

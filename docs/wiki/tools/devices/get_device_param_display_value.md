---
name: "get_device_param_display_value"
summary: ""
Live mapping: "- Reads `param.display_value` (Live 12+) when available, falls back to `str(param)` and returns `raw_value`."
---
...
```json
{
  "action": "get_device_param_display_value",
  "track_index": 1,
  "device_index": 0,
  "param_index": 2
}

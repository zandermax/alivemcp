---
name: "randomize_device"
summary: ""
Live mapping: "- Randomizes enabled, non-quantized parameters using uniform random sampling between `param.min` and `param.max`."
---

...
**Example request:**
```json
{"action": "get_all_param_display_values", "track_index": 1, "device_index": 0}
```

**Example response:**
```json
{"ok": true, "device_name": "EQ","count":3, "parameters":[{"index":0,"name":"Freq","raw_value":440.0,"display_value":"440 Hz","min":20.0,"max":20000.0,"is_quantized":false,"value_items":[]} ]}
```

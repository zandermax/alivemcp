...
summary: ""
Live mapping: "- Finds parameter by name; if `value` is a string it looks up `param.value_items` and sets the parameter index; otherwise clamps numeric value to `param.min`/`param.max` and writes `param.value`."
---

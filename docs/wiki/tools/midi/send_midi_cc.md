...
name: "send_midi_cc"
summary: ""
Live mapping: "- Calls `self.song.send_midi((status_byte, cc_number, cc_value))` where `status_byte = 176 + channel`. - Requires `song.send_midi` to be available on the host."
---

---
name: "get_notes_extended"
summary: ""
Live mapping: "- Calls `clip.get_notes_extended(from_time=..., from_pitch=..., time_span=..., pitch_span=...)` and returns structured notes."
---

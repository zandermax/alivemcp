---
name: "get_groove_pool_grooves"
summary: ""
Live mapping: "- Iterates `song.groove_pool` and returns `index`, `name`, and common groove amounts when available."
---
...
{
  "ok": true,
  "grooves": [{ "index": 0, "name": "Swing", "timing_amount": 0.5 }],
  "count": 1
}
```

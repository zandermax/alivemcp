---
name: "insert_automation_step"
summary: ""
Live mapping: "- Retrieves `clip.automation_envelope(param)` and calls `envelope.insert_step(time, value)` when available."
---

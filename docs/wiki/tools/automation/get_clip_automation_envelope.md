---
name: "get_clip_automation_envelope"
summary: ""
Live mapping: "- Uses `clip.automation_envelope(param)` to obtain the envelope object when available."
---
...
```json
{
  "action": "get_clip_automation_envelope",
  "track_index": 0,
  "clip_index": 0,
  "device_index": 0,
  "param_index": 1
